...
function memoize(func) {
  ...
  return function memoizedResultFunction() {
    if (cachedResult === null) cachedResult = func();
    return cachedResult;
  };
}
...
function partialUsingArguments(fn, ...args1) {
  return function resultFunction(...args2) {
